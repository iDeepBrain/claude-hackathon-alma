...
| # | Diagram | Description |
|---|---------|-------------|
| 1 | [Global Architecture](01-global-architecture.md) | All 5 Docker services and external connections |
...
| 4 | [MCP Memory](04-mcp-memory.md) | FastMCP server: 5 tools, 4-layer memory, SQLite + embeddings |
